"""Adam SP 23-DoF robot constants."""
...
ADAM_SP_XML: Path = (
  MJLAB_SRC_PATH / "asset_zoo" / "robots" / "adam_sp_23dof" / "xmls" / "adam_sp_23_dof.xml"
)
...
def get_spec() -> mujoco.MjSpec:
  ...
  # XML ships built-in actuators; remove them so mjlab articulation can
  # re-create actuators without name collisions.
...
ADAM_SP_23DOF_ACTION_SCALE: dict[str, float] = {}
for a in ADAM_SP_ARTICULATION.actuators:
  ...
  for n in names:
    ADAM_SP_23DOF_ACTION_SCALE[n] = 0.5


def get_adam_sp_23dof_robot_cfg() -> EntityCfg:
  """Get a fresh Adam SP 23-DoF robot configuration instance.
